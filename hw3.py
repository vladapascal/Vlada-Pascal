...
# Operațiile sunt: adunare, scădere, înmulțire, împărțire, modulul, exponențiere, împărțire întreagă

# CODUL TĂU VINE MAI JOS:
print("Adunare: ", number + number3)
print("Scădere:  ", number - number3)
print("Înmulțire:", number * number3)
print("Împărțire: ", number / number3)
print("Modulul: ", number % number3)
print("Exponențiere: ", number ** number3)
print("Împărțire întreagă: ", number // number3)
# CODUL TĂU VINE MAI SUS:
